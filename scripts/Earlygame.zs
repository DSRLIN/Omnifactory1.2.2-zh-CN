...
//Mining Hammers
<thermalfoundation:tool.hammer_stone>.displayName = "石质采矿锤";
<thermalfoundation:tool.hammer_stone>.addTooltip(format.red("千万别用它来拆格雷科技的多方块结构，方块会消失而不掉落！"));
<thermalfoundation:tool.hammer_tin>.displayName = "锡采矿锤";
<thermalfoundation:tool.hammer_tin>.addTooltip(format.red("千万别用它来拆格雷科技的多方块结构，方块会消失而不掉落！"));
<thermalfoundation:tool.hammer_copper>.displayName = "铜采矿锤";
<thermalfoundation:tool.hammer_copper>.addTooltip(format.red("千万别用它来拆格雷科技的多方块结构，方块会消失而不掉落！"));
<thermalfoundation:tool.hammer_nickel>.displayName = "镍采矿锤";
<thermalfoundation:tool.hammer_nickel>.addTooltip(format.red("千万别用它来拆格雷科技的多方块结构，方块会消失而不掉落！"));
<thermalfoundation:tool.hammer_platinum>.displayName = "铂采矿锤";
<thermalfoundation:tool.hammer_platinum>.addTooltip(format.red("千万别用它来拆格雷科技的多方块结构，方块会消失而不掉落！"));
<thermalfoundation:tool.hammer_bronze>.displayName = "青铜采矿锤";
<thermalfoundation:tool.hammer_bronze>.addTooltip(format.red("千万别用它来拆格雷科技的多方块结构，方块会消失而不掉落！"));
<thermalfoundation:tool.hammer_iron>.displayName = "铁采矿锤";
<thermalfoundation:tool.hammer_iron>.addTooltip(format.red("千万别用它来拆格雷科技的多方块结构，方块会消失而不掉落！"));
<thermalfoundation:tool.hammer_diamond>.displayName = "钻石采矿锤";
<thermalfoundation:tool.hammer_diamond>.addTooltip(format.red("千万别用它来拆格雷科技的多方块结构，方块会消失而不掉落！"));
...
<minecraft:shears>.displayName = "铁剪刀";
...
recipes.addShaped(<rangedpumps:pump>, [
	...
	[<minecraft:obsidian>, <gregtech:meta_item_1:32610>, <minecraft:obsidian>]]);
<rangedpumps:pump>.displayName = "末影泵";
...
<simplefluidtanks:wrench>.displayName = "多方块储罐扳手";
<simplefluidtanks:tankitem>.displayName = "多方块储罐方块";
<simplefluidtanks:valveitem>.displayName = "多方块储罐阀门";
...
recipes.addShaped(<enderio:item_yeta_wrench>, [
	...
	<gregtech:machine:511>.displayName = "电动高炉控制器";
	<gregtech:machine:702>.displayName = "流体输入仓(ULV)";
	<gregtech:machine:712>.displayName = "流体输入仓(LV)";
	<gregtech:machine:722>.displayName = "流体输入仓(MV)";
	<gregtech:machine:732>.displayName = "流体输入仓(HV)";
	<gregtech:machine:742>.displayName = "流体输入仓(EV)";
	<gregtech:machine:752>.displayName = "流体输入仓(IV)";
	<gregtech:machine:762>.displayName = "流体输入仓(LuV)";
	<gregtech:machine:772>.displayName = "流体输入仓(ZPM)";
	<gregtech:machine:782>.displayName = "流体输入仓(UV)";
	<gregtech:machine:792>.displayName = "流体输入仓(MAX)";
	<gregtech:machine:703>.displayName = "流体输出仓(ULV)";
	<gregtech:machine:713>.displayName = "流体输出仓(LV)";
	<gregtech:machine:723>.displayName = "流体输出仓(MV)";
	<gregtech:machine:733>.displayName = "流体输出仓(HV)";
	<gregtech:machine:743>.displayName = "流体输出仓(EV)";
	<gregtech:machine:753>.displayName = "流体输出仓(IV)";
	<gregtech:machine:763>.displayName = "流体输出仓(LuV)";
	<gregtech:machine:773>.displayName = "流体输出仓(ZPM)";
	<gregtech:machine:783>.displayName = "流体输出仓(UV)";
	<gregtech:machine:793>.displayName = "流体输出仓(MAX)";
...
<morefurnaces:furnaceblock>.addTooltip(format.red("当这个方块里还有燃料时，拆掉它会丢失所有燃料。"));
<morefurnaces:furnaceblock>.addTooltip(format.red("在拆掉它之前请回收你想要保留的燃料。"));
<morefurnaces:furnaceblock:1>.addTooltip(format.red("当这个方块里还有燃料时，拆掉它会丢失所有燃料。"));
<morefurnaces:furnaceblock:1>.addTooltip(format.red("在拆掉它之前请回收你想要保留的燃料。"));
<morefurnaces:furnaceblock:2>.addTooltip(format.red("当这个方块里还有燃料时，拆掉它会丢失所有燃料。"));
<morefurnaces:furnaceblock:2>.addTooltip(format.red("在拆掉它之前请回收你想要保留的燃料。"));
<morefurnaces:furnaceblock:3>.addTooltip(format.red("当这个方块里还有燃料时，拆掉它会丢失所有燃料。"));
<morefurnaces:furnaceblock:3>.addTooltip(format.red("在拆掉它之前请回收你想要保留的燃料。"));
<morefurnaces:furnaceblock:5>.addTooltip(format.red("当这个方块里还有燃料时，拆掉它会丢失所有燃料。"));
<morefurnaces:furnaceblock:5>.addTooltip(format.red("在拆掉它之前请回收你想要保留的燃料。"));
<morefurnaces:furnaceblock:6>.addTooltip(format.red("当这个方块里还有燃料时，拆掉它会丢失所有燃料。"));
<morefurnaces:furnaceblock:7>.addTooltip(format.red("当这个方块里还有燃料时，拆掉它会丢失所有燃料。"));
<morefurnaces:furnaceblock:6>.addTooltip(format.red("在拆掉它之前请回收你想要保留的燃料。"));
<morefurnaces:furnaceblock:7>.addTooltip(format.red("在拆掉它之前请回收你想要保留的燃料。"));
