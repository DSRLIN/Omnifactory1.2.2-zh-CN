...
<appliedenergistics2:material:10>.addTooltip(format.red("将赛特斯石英种子放入晶体催生仓获得。"));
<appliedenergistics2:material:11>.addTooltip(format.red("将下界石英种子放入晶体催生仓获得。"));
<appliedenergistics2:material:12>.addTooltip(format.red("将福鲁伊克斯种子放入晶体催生仓获得。"));
