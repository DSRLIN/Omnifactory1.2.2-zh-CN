...
<dimensionaledibles:overworld_cake>.addTooltip(format.darkAqua(format.italic("用橡树苗补充次数。")));
...
<dimensionaledibles:nether_cake>.addTooltip(format.darkAqua(format.italic("用黑曜石补充次数。")));
...
<dimensionaledibles:end_cake>.addTooltip(format.darkAqua(format.italic("用末影之眼补充次数。")));

//Voidworld Cake
recipes.addShaped(<dimensionaledibles:custom_cake>.withTag({dimID: 119, cakeName: "虚空世界"}), [[<actuallyadditions:item_crystal>,<actuallyadditions:item_crystal:1>,<actuallyadditions:item_crystal:4>], [<forestry:crafting_material>, <enderio:item_material:70>, <forestry:crafting_material>],[<gregtech:meta_item_1:12001>,<gregtech:meta_item_1:12001>,<gregtech:meta_item_1:12001>]]);
<dimensionaledibles:custom_cake>.withTag({dimID: 119, cakeName: "虚空世界"}).addTooltip(format.darkAqua(format.italic("用脉动之尘补充次数。")));

mods.jei.JEI.addItem(<dimensionaledibles:custom_cake>.withTag({dimID: 119, cakeName: "虚空世界"}));
