...
<extendedcrafting:material:19>.displayName = "融合合成组件";
...
<extendedcrafting:material:13>.displayName = "融合合成催化剂";
...
<extendedcrafting:table_advanced>.displayName = "拓展合成桌";
...
<extendedcrafting:table_elite>.displayName = "精英拓展合成桌";
...
<extendedcrafting:table_ultimate>.displayName = "终极拓展合成桌";
...
<extendedcrafting:singularity_ultimate>.displayName = "万象之尘";
...
<cns:star_fragment>.displayName = "下界之星顶角";
...
<cns:star_core>.displayName = "下界之星核心";
...
<contenttweaker:eternalcatalyst>.addTooltip(format.darkGray(format.italic("凝视深渊……")));
<gregtech:meta_item_1:32725>.clearTooltip();
<gregtech:meta_item_1:32725>.addTooltip(format.darkPurple("量子之星"));
<gregtech:meta_item_1:32725>.displayName = "量子之星";
...
<contenttweaker:ultimate_gem>.addTooltip(format.yellow("无序配方。"));
...
<contenttweaker:ultimate_generator>.addTooltip(format.yellow("无序配方。"));
...
<gregtech:turbine_casing:3>.displayName = "镁铝合金涡轮外壳";
