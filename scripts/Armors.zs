...
recipes.addShaped(<armorplus:coal_boots>, [
	[<contenttweaker:carbonarmorplate>, null, <contenttweaker:carbonarmorplate>],
	[<contenttweaker:carbonarmorplate>, null, <contenttweaker:carbonarmorplate>]]);
<armorplus:coal_helmet>.displayName = "碳板防护头盔";
<armorplus:coal_chestplate>.displayName = "碳板防护胸甲";
<armorplus:coal_leggings>.displayName = "碳板防护护腿";
<armorplus:coal_boots>.displayName = "碳板防护靴子";
