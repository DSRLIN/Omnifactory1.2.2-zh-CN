...
<deepmoblearning:glitch_fragment>.addTooltip(format.aqua(format.italic("拿着故障之心敲击黑曜石获得。")));
<appliedenergistics2:material:1>.addTooltip(format.aqua(format.italic("在AE2充能器中充能获得。")));
