...
<enderio:block_cap_bank:2>.displayName = "进阶电容库";
...
//不知道为什么这个地方被注释掉了
//<thermalexpansion:frame:128>.displayName = "铅石能量单元框架";
//<thermalexpansion:cell>.displayName = "铅石能量单元";
<thermalexpansion:frame:130>.displayName = "微型挖矿机引擎框架";
<thermalexpansion:frame:146>.displayName = "微型挖矿机引擎核心";
<thermalexpansion:frame:131>.displayName = "信素微型挖矿机引擎框架";
<thermalexpansion:frame:147>.displayName = "信素微型挖矿机引擎核心";
<thermalexpansion:frame:132>.displayName = "末影微型挖矿机引擎框架";
<thermalexpansion:frame:148>.displayName = "末影微型挖矿机引擎核心";
