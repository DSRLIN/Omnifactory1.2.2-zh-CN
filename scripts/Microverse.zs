...
<modularmachinery:blockcontroller>.displayName = "模块化机器控制器";
...
<modularmachinery:blockenergyinputhatch>.displayName = "模块化能源输入仓(LV)";
<modularmachinery:blockenergyinputhatch:1>.displayName = "模块化能源输入仓(MV)";
<modularmachinery:blockenergyinputhatch:2>.displayName = "模块化能源输入仓(HV)";
<modularmachinery:blockenergyinputhatch:3>.displayName = "模块化能源输入仓(EV)";
<modularmachinery:blockenergyinputhatch:4>.displayName = "模块化能源输入仓(IV)";
<modularmachinery:blockenergyinputhatch:5>.displayName = "模块化能源输入仓(LuV)";
<modularmachinery:blockenergyinputhatch:6>.displayName = "模块化能源输入仓(ZPM)";
<modularmachinery:blockenergyinputhatch:7>.displayName = "模块化能源输入仓(UV)";
...
<modularmachinery:blockenergyoutputhatch>.displayName = "模块化能源输出仓(LV)";
<modularmachinery:blockenergyoutputhatch:1>.displayName = "模块化能源输出仓(MV)";
<modularmachinery:blockenergyoutputhatch:2>.displayName = "模块化能源输出仓(HV)";
<modularmachinery:blockenergyoutputhatch:3>.displayName = "模块化能源输出仓(EV)";
<modularmachinery:blockenergyoutputhatch:4>.displayName = "模块化能源输出仓(IV)";
<modularmachinery:blockenergyoutputhatch:5>.displayName = "模块化能源输出仓(LuV)";
<modularmachinery:blockenergyoutputhatch:6>.displayName = "模块化能源输出仓(ZPM)";
<modularmachinery:blockenergyoutputhatch:7>.displayName = "模块化能源输出仓(UV)";
...
<contenttweaker:tieroneship>.addTooltip(format.italic(format.white("在微型宇宙中从小行星上收集钛和其它轻金属。")));
...
<contenttweaker:tiertwoship>.addTooltip(format.white(format.italic("在微型宇宙中从小行星上收集钨和其它重金属。")));
...
<contenttweaker:tierthreeship>.addTooltip(format.white(format.italic("从微型地狱宇宙中收集超高温的金属和宝石。")));
...
<gregtech:meta_item_1:32724>.displayName = "量子之眼";
<gregtech:meta_item_1:32724>.clearTooltip();
<gregtech:meta_item_1:32724>.addTooltip(format.darkPurple("量子之眼"));
...
<contenttweaker:universalnavigator>.addTooltip(format.blue("导航员，拜拜了您呐！"));
...
<extendedcrafting:trimmed:0>.displayName = "黑钢块";
<extendedcrafting:trimmed:1>.displayName = "黑钢块";
<extendedcrafting:trimmed:2>.displayName = "黑钢块";
<extendedcrafting:trimmed:3>.displayName = "黑钢块";
<extendedcrafting:trimmed:4>.displayName = "黑钢块";
<extendedcrafting:trimmed:5>.displayName = "黑钢块";
<extendedcrafting:trimmed:5>.clearTooltip();
<extendedcrafting:trimmed:5>.addTooltip("黑钢块");
<extendedcrafting:trimmed:5>.addTooltip(format.gray(format.italic("万象镶框")));
...
<actuallyadditions:item_solidified_experience>.addTooltip(format.green("通过在经验固化器中制作。"));


<contenttweaker:tierfourship>.addTooltip(format.white(format.italic("从空旷的宇宙深处收集超低温材料。")));
<contenttweaker:tierfiveship>.addTooltip(format.white(format.italic("从微型末地宇宙中收集奇异的材料。")));
<contenttweaker:tiersixship>.addTooltip(format.italic(format.white("从一切可及之处收集极其稀有的材料。")));
<contenttweaker:tiersevenship>.addTooltip(format.white(format.italic("在微型宇宙中狩猎双足飞龙和末影龙")));
<contenttweaker:tiersevenship>.addTooltip(format.white(format.italic("带回它们的外壳和战利品。")));
<contenttweaker:tiereightship>.addTooltip(format.italic(format.white("狩猎比末地更不可及的怪兽")));
<contenttweaker:tiereightship>.addTooltip(format.italic(format.white("带回奇妙的小玩意。")));
<contenttweaker:tiernineship>.addTooltip(format.italic(format.white("使微型宇宙的恒星坍塌并收集它们美味的中子素核心。")));
<contenttweaker:tiertenship>.addTooltip(format.italic(format.white("使整个微型宇宙坍塌并把它整个收集起来。")));
<contenttweaker:tiertenship>.addTooltip(format.italic(format.white("请瞄准没有生命定居的微型宇宙。")));
