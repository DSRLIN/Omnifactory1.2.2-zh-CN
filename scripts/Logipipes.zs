...
print("--- loading Logipipes.zs ---");
	...
	#Tooltips
	<logisticspipes:crafting_table>.addTooltip("用于使用逻辑自动合成");
	<logisticspipes:crafting_table_fuzzy>.addTooltip("用于使用逻辑自动合成");
	<logisticspipes:pipe_request_table>.addTooltip("这是你的逻辑合成终端");
